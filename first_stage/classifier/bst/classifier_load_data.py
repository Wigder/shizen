...
with open("out/classifier_sequence_length.pickle", "wb") as f:
    pickle.dump(sequence_length, f, pickle.HIGHEST_PROTOCOL)

# Establishing vocab indices.
tokenizer = Tokenizer()
tokenizer.fit_on_texts(data)
with open("out/classifier_tokenizer.pickle", "wb") as f:
