...
embedding = Embedding(vocab_size, dimensions, weights=[load_word_embeddings()], input_length=sequence_length)(inputs)
...
save_outputs(model, history, "Trainable", __file__)
