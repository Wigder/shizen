...
dem_train, dem_test = train_test_split(dem_data, train_size=100000)
dem_train, dem_val = train_test_split(dem_train, test_size=0.1)
rep_train, rep_test = train_test_split(rep_data, train_size=100000)
rep_train, rep_val = train_test_split(rep_train, test_size=0.1)
